                    ...
                    <div class="pp-settings-content">
                                    ...
                                    <div class="pp-option-row" style="flex-direction: column; align-items: flex-start; gap: 15px;">
                                        ...
                                        <div class="pp-help-box" style="background: #f8fafc; border: 1px solid #e2e8f0; padding: 15px; border-radius: 4px; font-size: 13px; color: #475569; width: 100%; box-sizing: border-box;">
                                            ...
                                            <div style="background: #fff; padding: 12px; border: 1px solid #cbd5e1; margin-top: 10px;">
                                                ...
                                                <code style="background: #f1f5f9; padding: 2px 4px; border-radius: 3px;">MonStudio-{gallery_title}</code>
                                                <div style="margin-top: 8px; padding-top: 8px; border-top: 1px dashed #eee; font-size: 12px; color: #1e293b;">
                                                    <?php
                                                    printf(
                                                        // translators: %1$s: Gallery title, %2$s: resulting filename
                                            ...
                                            <p style="margin-top: 15px; font-size: 11px; border-top: 1px solid #e2e8f0; padding-top: 10px; color: #64748b; line-height: 1.4;">
                                                ...
                                                <?php esc_html_e( 'A counter (0001, 0002…) is added automatically at the end of every file name.', 'photoproof' ); ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="section-design" class="pp-section-content">
                            <div class="pp-card">
                                ...
                                <div class="pp-branding-grid">
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 12px;">
                                        ...
                                        <div style="display: flex; gap: 8px; justify-content: center;">
                                            ...
                                            <button type="button" class="button button-secondary" id="photoproof_upload_custom_logo_btn">
                                ...
                                <hr class="pp-separator">
<h3><?php esc_html_e( 'Gallery Layout', 'photoproof' ); ?></h3>
                                <div class="pp-option-row">
                                    <label class="pp-switch">
                                    ...
                                    <span class="pp-label-text">
                                        <?php esc_html_e( 'Masonry layout', 'photoproof' ); ?>
                                    </span>
                                </div>
                                <p class="pp-explanation">
                                    <?php esc_html_e( 'By default, photos are displayed in a uniform grid (all same height).', 'photoproof' ); ?>
                                    <br>
                                    <?php esc_html_e( 'Enable this option for a Pinterest-style masonry layout that preserves each photo\'s original aspect ratio.', 'photoproof' ); ?>
                                </p>
                            ...
                            <div class="pp-card">
                                ...
                                <div class="pp-branding-grid">
                                    <div class="pp-branding-controls">
                                        ...
                                        <button type="button" class="button button-secondary" id="photoproof_upload_watermark_btn">
