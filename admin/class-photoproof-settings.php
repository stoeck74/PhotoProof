...
class PhotoProof_Settings {
    ...
    public function register_settings() {
        ...
        register_setting( 'pp_settings_group', 'pp_color_bg' );
        register_setting( 'pp_settings_group', 'pp_color_active' );
        register_setting( 'pp_settings_group', 'pp_color_text' );
    }
            ...
            <form method="post" action="options.php">
                ...
                <div class="pp-settings-container">
                    ...
                    <div class="pp-settings-content">
                        ...
                        <div id="section-general" class="pp-section-content active">
                            <div class="pp-card">
                                ...
                                <p class="pp-explanation">
                                    Transforme vos liens (ex: <code>/galerie/mariage-annecy</code>) en codes impossibles à deviner (ex: <code>/galerie/550e8400...</code>).
                                </p>
                                        ...
                                        <div class="pp-help-box" style="background: #f8fafc; border: 1px solid #e2e8f0; padding: 15px; border-radius: 4px; font-size: 13px; color: #475569; width: 100%; box-sizing: border-box;">
                                            ...
                                            <ul style="margin: 10px 0; padding-left: 20px; list-style: disc;">
                                                <li style="margin-bottom: 10px;">
                                                    ...
                                                    <br><span style="color: #2271b1; font-weight: 500;">👉 Si vous remplissez le "Nom personnalisé" dans une galerie, c'est ce dernier qui viendra remplir cette balise, sans modifier le reste de votre structure.</span>
                                                </li>
                                                <li>
                                            ...
                                            <div style="background: #fff; padding: 12px; border: 1px solid #cbd5e1; margin-top: 10px;">
                                                <p style="margin: 0 0 5px 0; font-size: 11px; text-transform: uppercase; color: #94a3b8;">Exemple de structure avec marque :</p>
                                                ...
                                                <div style="margin-top: 8px; padding-top: 8px; border-top: 1px dashed #eee; font-size: 12px; color: #1e293b;">
                                                    Si votre galerie s'appelle <strong>"Reportage Annecy"</strong> :
                                                    <br>Résultat : <code style="color: #059669;">MonStudio-reportage-annecy-0001.jpg</code>
                                                </div>
                                            </div>
                                            ...
                                            <p style="margin-top: 15px; font-size: 11px; border-top: 1px solid #e2e8f0; padding-top: 10px; color: #64748b; line-height: 1.4;">
                                                ...
                                                <strong>Note :</strong> La balise <code>{index}</code> garantit un tri alphabétique parfait. Si vous ne la placez pas vous-même dans la structure, PhotoProof l'ajoutera automatiquement à la fin du nom par sécurité.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="recommendation-details" class="pp-sub-panel" style="display: <?php echo get_option('pp_enable_recommendations') ? 'block' : 'none'; ?>; margin-top: 15px;">
                                    ...
                                    <select name="pp_global_recommendation_icon" style="width:100%; max-width:250px;">
                                        <option value="dot" <?php selected(get_option('pp_global_recommendation_icon'), 'dot'); ?>>■ Point (Archi / Minimaliste)</option>
                                        <option value="star" <?php selected(get_option('pp_global_recommendation_icon'), 'star'); ?>>★ Étoile (Standard)</option>
                                        <option value="heart" <?php selected(get_option('pp_global_recommendation_icon'), 'heart'); ?>>❤ Cœur (Mariage)</option>
                                    </select>
                                </div>
                                ...
                                <div class="pp-option-row">
                                    <label class="pp-switch">
                                        <input type="checkbox" name="pp_enable_expiration" value="1" <?php checked(1, get_option('pp_enable_expiration'), true); ?>>
                                        <span class="pp-slider"></span>
                                    </label>
                                    <span class="pp-label-text">Désactivation automatique après 30 jours</span>
                                </div>
                                <p class="pp-explanation">Si activé, l'accès client sera coupé 30 jours après la mise en ligne.</p>
                            </div>
                        </div>
                                ...
                                <div class="pp-branding-grid">
                                    <div class="pp-branding-controls">
                                        ...
                                        <div class="pp-range-group" style="margin-top:20px;">
                                            ...
                                            <input type="range" name="pp_watermark_opacity" id="pp_watermark_opacity_range" min="10" max="100" step="5" value="<?php echo esc_attr(get_option('pp_watermark_opacity', 50)); ?>" style="width:100%;">
                                        </div>
                                    </div>
                                    <div class="pp-branding-preview">
                                        <div id="wm-preview-container" style="border: 1px dashed #ccc; padding: 10px; text-align: center; min-height: 100px; display: flex; align-items: center; justify-content: center; background: #f0f0f0;">
                                            ...
                                            if ($wm_id) : 
                                                ...
                                                $opacity = get_option('pp_watermark_opacity', 50) / 100;
                                                echo '<img id="wm-live-preview" src="'.esc_url($url).'" style="opacity:'.$opacity.'; max-width:150px; height:auto;">';
                                            else : 
                                ...
                                <div class="pp-branding-grid">
                                    ...
                                    <div class="pp-branding-preview">
                                        <div id="custom-logo-preview-container">
                                            ...
                                            if ($custom_logo_id) echo wp_get_attachment_image($custom_logo_id, 'medium', false, array('style' => 'max-width:150px; height:auto;'));
                                            else echo '<p style="color:#94a3b8;">Logo du site par défaut</p>'; ?>
                                        </div>
                                    </div>
                                </div>
                                <hr class="pp-separator">
                        ...
                        <div class="pp-save-bar" style="margin-top: 20px; padding: 20px; background: #fff; border-top: 1px solid #ddd; display: flex; justify-content: flex-end;">
